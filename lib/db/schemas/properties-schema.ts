...
export const properties = pgTable('properties', {
  ...
  auctionOrganizerOrganizationId: uuid('auction_organizer_organization_id').references(() => organizations.id, { onDelete: 'set null' }),
  auctionCreatedByUserId: uuid('auction_created_by_user_id').references(() => users.id, { onDelete: 'set null' }),
...
export const auctionBids = pgTable('auction_bids', {
  ...
  invalidatedBy: uuid('invalidated_by').references(() => users.id, { onDelete: 'set null' }),
  ...
  propertyAmountIdx: index('auction_bids_property_amount_idx').on(table.propertyId, table.amount, table.createdAt),
}));
