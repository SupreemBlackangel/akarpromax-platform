export const SERVICES_TABLES_SQL: string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS service_orders (
    ...
    source_type VARCHAR(24) NOT NULL DEFAULT 'rfq',
    provider_profile_id VARCHAR(36) NULL,
    category_id VARCHAR(36) NULL,
    service_title_snapshot TEXT NULL,
    price_snapshot INTEGER NULL,
    currency_snapshot VARCHAR(8) NULL,
    pricing_unit_snapshot VARCHAR(32) NULL,
    ...
    contact_preference VARCHAR(16) NULL,
    contact_phone VARCHAR(32) NULL,
    contact_email VARCHAR(255) NULL,
    contact_revealed_at DATETIME NULL,
    declined_at DATETIME NULL,
    provider_response_note TEXT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
  )`,
