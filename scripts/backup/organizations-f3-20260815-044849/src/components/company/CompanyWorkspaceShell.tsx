...
const TABS: Array<{ key: string; label: string; href: string; icon: string }> = [
  { key: "dashboard", label: "لوحة التحكم", href: "/dashboard/company", icon: "📊" },
  { key: "profile", label: "ملف الشركة", href: "/dashboard/company/profile", icon: "🏢" },
  { key: "services", label: "الخدمات", href: "/dashboard/company/services", icon: "🧰" },
  { key: "members", label: "الأعضاء", href: "/dashboard/company/members", icon: "👥" },
  { key: "branches", label: "الفروع", href: "/dashboard/company/branches", icon: "📍" },
  { key: "portfolio", label: "المشاريع", href: "/dashboard/company/portfolio", icon: "📁" },
  { key: "capabilities", label: "القدرات", href: "/dashboard/company/capabilities", icon: "⚙️" },
  { key: "specialties", label: "التخصصات", href: "/dashboard/company/specialties", icon: "✨" },
];

export function CompanyWorkspaceShell({ activeTab, children }: CompanyWorkspaceShellProps) {
          ...
          <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                ملف الشركة، الخدمات، الأعضاء والفروع
              </p>
            </div>
