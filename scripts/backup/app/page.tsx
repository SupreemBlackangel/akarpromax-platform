...
export default function Home() {
  ...
  const [sidebarCollapsed, setSidebarCollapsed] = useState(() => {
    ...
    try { return window.localStorage.getItem("akarpromax-sidebar-collapsed") === "true"; } catch { return false; }
  });
  ...
  const toggleSidebar = () => {
    setSidebarCollapsed((current) => {
      const next = !current;
      try { window.localStorage.setItem("akarpromax-sidebar-collapsed", String(next)); } catch { /* ignore */ }
      return next;
    });
  };
