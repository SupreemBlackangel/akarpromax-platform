    ...
    <ServiceDashboardShell viewer={viewer} locale={locale} dir={dir} t={t} active="favorites">
      <PageContainer dir={dir} className="py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-[var(--color-text-primary)]">{t("services.favorites") ?? "المفضلة"}</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-[var(--color-text-primary)]">{t("services.noFavorites") ?? "لا توجد عناصر مفضلة"}</h2>
