  ...
  return (
    <OfficeWorkspaceShell activeTab="sync">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h2 className="font-black text-gray-900 dark:text-white">عمليات المزامنة</h2>
        <button type="button" onClick={() => void retry()} className="rounded-xl bg-blue-600 px-4 py-2 text-xs font-black text-white hover:bg-blue-700">
