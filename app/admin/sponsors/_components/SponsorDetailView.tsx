...
export default function SponsorDetailView() {
  ...
  if (!profile) {
    return (
      <div className="max-w-2xl mx-auto p-6 text-center" dir="rtl">
        ...
        <Link href="/admin/sponsors" className="text-blue-600 hover:underline mt-2 inline-block">العودة إلى القائمة</Link>
      </div>
    );
  }
    ...
    <div className="max-w-3xl mx-auto p-6" dir="rtl">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <Link href={`/admin/sponsors/${profile.id}/edit`} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm">
            تعديل
          </Link>
          <button onClick={() => router.push("/admin/sponsors")} className="px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors text-sm">
            عودة
          </button>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="p-6 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 font-mono">{profile.sponsorCode}</span>
          </div>
