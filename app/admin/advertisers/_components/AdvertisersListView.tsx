  ...
  return (
    <div className="max-w-6xl mx-auto p-6" dir="rtl">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="bg-[var(--color-surface)] dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-x-auto">
                ...
                <tr key={profile.id} className="border-b border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                  ...
                  <td className="p-3">
                    <div className="flex gap-1">
                      <Link href={`/admin/advertisers/${profile.id}`} className="px-2 py-1 text-xs bg-[var(--color-primary-soft)] dark:bg-[var(--color-primary-soft)]/20 text-[var(--color-primary)] dark:text-[var(--color-primary)] rounded hover:bg-[var(--color-primary-soft)] dark:hover:bg-blue-900/40 transition-colors">عرض</Link>
