...
export const translations: Record<Locale, Translation> = {
  ar: {
    ...
    locationAndSettings: "الموقع والإعدادات",
    ...
    navEngineeringTools: "الأدوات الهندسية",
    navServices: "سوق الخدمات",
    navDirectory: "الدليل",
    navOrganizations: "الشركات",
    navProviders: "المحترفون",
    navRealEstateCompanies: "شركات و مكاتب عقارية",
    navOtherCompanies: "شركات أخرى",
    navCommunity: "منتدى البناء و العقار",
    navKnowledge: "الكتب والبرامج",
    navAdvertise: "اعلن معنا",
    navAbout: "من نحن",
    navContact: "اتصل بنا",
    navTerms: "الشروط والأحكام",
    navPrivacy: "سياسة الخصوصية",
    navDataDeletion: "حذف البيانات",
  ...
  en: {
    ...
    showMenu: "Show menu",
    locationAndSettings: "Location & settings",
  ...
  tr: {
    ...
    locationAndSettings: "Konum ve ayarlar",
    ...
    navEngineeringTools: "Muhendislik Araclari",
    navServices: "Hizmetler",
    navDirectory: "Dizin",
    navOrganizations: "Şirketler",
    navProviders: "Uzmanlar",
    navRealEstateCompanies: "Emlak Sirketleri ve Ofisleri",
    navOtherCompanies: "Diger Sirketler",
    navCommunity: "Insaat ve Gayrimenkul Forumu",
    navKnowledge: "Kitaplar ve Yazilimlar",
    navAdvertise: "Bizimle Reklam Verin",
    navAbout: "Hakkimizda",
    navContact: "Iletisim",
    navTerms: "Sartlar ve Kosullar",
    navPrivacy: "Gizlilik Politikasi",
    navDataDeletion: "Veri Silme",
