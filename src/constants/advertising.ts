...
const LEGACY_AD_PLACEMENTS: Record<string, PlacementMeta> = {
  ...
  office_dashboard_hero: legacyPlacement("office_dashboard_hero", "الإعلان الرئيسي في تطبيق المكتب", "Office app main banner", "Ofis paneli büyük banner", ["office"], "horizontal", { channel: "office", adminSelectable: true, pageFamily: "office", position: "hero", aspectRatio: "5:2" }),
  // The desktop application (webui 3.x) draws this as a full-height column
  // beside the content, so the creative is tall: about 1:3 at 1366x768.
  office_dashboard_sidebar: legacyPlacement("office_dashboard_sidebar", "العمود الجانبي في تطبيق المكتب", "Office app side column", "Ofis uygulaması yan sütun", ["office"], "vertical", { channel: "office", adminSelectable: true, pageFamily: "office", position: "sidebar", aspectRatio: "1:3" }),
  // The strip across the bottom of every screen in the desktop application.
  office_bottom_strip: legacyPlacement("office_bottom_strip", "الشريط السفلي في تطبيق المكتب", "Office app bottom strip", "Ofis uygulaması alt şerit", ["office"], "horizontal", { channel: "office", adminSelectable: true, pageFamily: "office", position: "bottom", aspectRatio: "10:1" }),
