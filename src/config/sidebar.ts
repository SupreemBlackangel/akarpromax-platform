...
export const serviceSupervisorSidebarConfig: SidebarConfig = {
  items: [
    ...
    { key: "pending-review", labelKey: "services.pendingReview", href: "/dashboard/services/supervisor/requests?status=pending", icon: "⏳", requiredPermission: PERMISSIONS.SERVICE_REQUESTS_MANAGE_ALL },
    { key: "open-requests", labelKey: "services.openRequests", href: "/dashboard/services/supervisor/requests?status=open", icon: "📂", requiredPermission: PERMISSIONS.SERVICE_REQUESTS_MANAGE_ALL },
    { key: "in-progress", labelKey: "services.inProgress", href: "/dashboard/services/supervisor/jobs?status=in_progress", icon: "🔧", requiredPermission: PERMISSIONS.SERVICE_REQUESTS_MANAGE_ALL },
    { key: "offers", labelKey: "services.allOffers", href: "/dashboard/services/supervisor/offers", icon: "💼", requiredPermission: PERMISSIONS.SERVICE_OFFERS_MANAGE_ALL },
    ...
    { key: "categories", labelKey: "services.categories", href: "/dashboard/services/supervisor/categories", icon: "🗂", requiredPermission: PERMISSIONS.SERVICE_CATEGORIES_MANAGE },
    { key: "coverage-areas", labelKey: "services.coverageAreas", href: "/dashboard/services/supervisor/coverage", icon: "🗺", requiredPermission: PERMISSIONS.SERVICE_CATEGORIES_MANAGE },
    { key: "reviews", labelKey: "services.moderateReviews", href: "/dashboard/services/supervisor/reviews", icon: "⭐", requiredPermission: PERMISSIONS.SERVICES_REVIEW_MODERATE },
    { key: "disputes", labelKey: "services.disputes", href: "/dashboard/services/supervisor/disputes", icon: "⚖", requiredPermission: PERMISSIONS.SERVICES_DISPUTE_RESOLVE },
    { key: "service-ads", labelKey: "services.ads", href: "/dashboard/services/supervisor/ads", icon: "📢", requiredPermission: PERMISSIONS.SERVICE_ADS_MANAGE },
    { key: "notifications", labelKey: "services.notifications", href: "/dashboard/services/supervisor/notifications", icon: "🔔", requiredPermission: PERMISSIONS.SERVICE_NOTIFICATIONS_VIEW },
    { key: "reports", labelKey: "services.reports", href: "/dashboard/services/supervisor/reports", icon: "📈", requiredPermission: PERMISSIONS.SERVICE_REPORTS_MANAGE },
    { key: "settings", labelKey: "services.settings", href: "/dashboard/services/supervisor/settings", icon: "⚙", requiredPermission: PERMISSIONS.SETTINGS_MANAGE },
    { key: "audit-log", labelKey: "services.auditLog", href: "/dashboard/services/supervisor/audit", icon: "📝", requiredPermission: PERMISSIONS.SERVICE_REPORTS_MANAGE },
  ],
  getVisibleItems: (identity) => {
