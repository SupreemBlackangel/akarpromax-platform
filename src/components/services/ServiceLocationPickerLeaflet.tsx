...
export default function ServiceLocationPickerLeaflet({ latitude, longitude, selected = true, onChange }: { latitude: number; longitude: number; selected?: boolean; onChange: (value: Coordinates) => void }) {
