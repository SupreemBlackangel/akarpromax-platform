      ...
      <PageContainer className="py-8" dir={dir}>
        <div className="space-y-8">
          {page.sections.map((section) => (
            <section key={section.title.en} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                  ...
                  {section.cards.map((card) => {
                    ...
                    return (
                      <div key={`${destination}-${card.href}`} className="rounded-2xl border border-gray-200 bg-gray-50 p-5 dark:border-gray-800 dark:bg-gray-950/40">
                        ...
                        <LinkTag {...linkProps} className="mt-4 inline-flex items-center rounded-xl bg-blue-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-blue-700">
